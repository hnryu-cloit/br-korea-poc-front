export type DemoRole = "hq_admin" | "supervisor" | "store_owner";
...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { to: "/sv/coaching", label: "주문 코칭", icon: "support_agent" },
      { to: "/sv/inspection", label: "생산 점검", icon: "inventory_2" },
    ],
  },
  {
    section: "본사",
...
export const routeDescriptions: Record<string, string> = {
  ...
  "/sv/coaching": "담당 매장 주문 현황을 확인합니다.",
  "/sv/inspection": "매장별 생산 준수 현황을 점검합니다.",
