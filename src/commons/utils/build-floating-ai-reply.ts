...
const cardContextReplies: Record<FloatingAiCardContextKey, FloatingAiChatMessage> = {
  ...
  "production:inventory-status": {
    ...
    title: "재고 수준 진단 결과",
    content:
      "부족 품목은 오늘 오후 피크 전까지 추가 생산이 필요합니다. 여유 품목은 당일 소진을 위해 묶음 판매 또는 할인 행사를 고려할 수 있습니다. 적정 수준은 일 평균 판매량의 1.5배를 기준으로 잡는 게 안전합니다.",
    evidence: ["부족 품목 3건", "여유 품목 2건", "적정 기준 1.5x 일 평균"],
  },
  "production:waste": {
    id: 1,
    title: "폐기 손실 원인 분석",
