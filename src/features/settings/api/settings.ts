...
import type { PromptSettingsResponse, PromptSettingsUpdateRequest } from "@/features/settings/types/settings";
...
export async function putPromptSettings(payload: PromptSettingsUpdateRequest): Promise<PromptSettingsResponse> {
