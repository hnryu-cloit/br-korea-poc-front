  ...
  return (
    <section className="grid gap-4 sm:grid-cols-3">
      {[
        {
          label: "정상 완료",
          value: formatCountWithUnit(normalCount, "개"),
          className: "bg-green-50 text-green-600 border border-green-100",
        },
        {
          label: "검토 필요",
          value: formatCountWithUnit(reviewCount, "개"),
        ...
        >
          ...
          <div
            className={`mt-4 inline-flex rounded-full px-3 py-1 text-sm font-semibold ${item.className}`}
          >
            {item.value}
          </div>
        </article>
