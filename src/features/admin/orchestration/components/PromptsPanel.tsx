...
import type { PromptDomainKey, SettingsModalKey } from "@/features/admin/orchestration/types/orchestration";
  ...
  return (
    <section>
      <div className="pgh">
        ...
        <div className="pgh-r">
          <span className="b bo">마지막 수정: {updatedAtText} {updatedBy ? `· ${updatedBy}` : ""}</span>
          {isDirty ? <span className="b ba">미저장</span> : null}
          <button type="button" className="btn btn-g btn-sm" disabled={!isDirty || isSaving} onClick={onReset}>
            되돌리기
          </button>
          <button type="button" className="btn btn-p btn-sm" disabled={!isDirty || isSaving} onClick={onSave}>
            {isSaving ? "저장 중" : "저장"}
          </button>
        </div>
      </div>
      ...
      <div className="psubtab active">
        <div className="g2" style={{ marginBottom: 10 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div className="pc">
              <div className="pc-hdr">
                <span className="b bg" style={{ fontSize: 10 }}>대화</span>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 5 }}>
                <span style={{ fontSize: 10, color: "var(--t3)" }}>변수: {'{store_id}'} {'{threshold}'}</span>
                <span className="b bb" style={{ fontSize: 9.5 }}>v3.2.1</span>
              </div>
            </div>

            <div className="pc">
              <div className="pc-hdr">
                <span className="b bpu" style={{ fontSize: 10 }}>시각화</span>
              ...
              />
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 5 }}>
                <span style={{ fontSize: 10, color: "var(--t3)" }}>변수: {'{chart_type}'} {'{data_range}'}</span>
                <span className="b bb" style={{ fontSize: 9.5 }}>v1.0.2</span>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div className="pc">
              <div className="pc-hdr">
                <span className="b bo" style={{ fontSize: 10 }}>인사이트</span>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 5 }}>
                ...
                <span className="b bb" style={{ fontSize: 9.5 }}>v2.1.0</span>
              </div>
            </div>

            <div className="pc">
              <div className="pc-hdr">
                <span className="b bgy" style={{ fontSize: 10 }}>빠른질문</span>
        ...
        <div className="card" style={{ marginBottom: 0 }}>
          <div className="ch"><span className="ct">쿼리 접두 템플릿</span></div>
          <input
            className="si"
            type="text"
            value={activeForm.queryPrefixTemplate}
            onChange={(e) => onFieldChange(activeAgent, "queryPrefixTemplate", e.target.value)}
          />
          <div className="ch" style={{ marginTop: 10 }}><span className="ct" style={{ fontSize: 12 }}>버전 이력</span></div>
          <div className="tw">
            <table>
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  <td style={{ fontWeight: 700, color: "var(--orange)" }}>
                    v3.2.1 <span className="b bg" style={{ fontSize: 9 }}>현재</span>
                  </td>
                  <td className="sub">2026-04-18</td>
                  <td className="sub">빠른 질문 3개 추가, 인사이트 임계값 강화</td>
                  <td className="sub">hq_admin</td>
                  <td><button type="button" className="btn btn-g btn-sm">복원</button></td>
                </tr>
                <tr>
                  <td>v3.2.0</td>
