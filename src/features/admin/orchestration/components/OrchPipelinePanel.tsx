  ...
  return (
    <section>
      <div className="pgh">
        ...
        <div className="pgh-r">
          <button type="button" className="btn btn-g btn-sm">파이프라인 이력</button>
          <button type="button" className="btn btn-p btn-sm">설정 저장</button>
        </div>
      </div>
      ...
      <div className="card">
        <div className="ch">
          ...
          <span className="b bb" style={{ marginLeft: "auto" }}>실시간 적용</span>
        </div>
        <div className="pipeline">
          <div className="pipe-node active-node">
            <div className="pipe-label">진입점</div>
            <div className="pipe-name">질의 수신</div>
            <div style={{ fontSize: 10, color: "var(--t2)", marginTop: 3 }}>역할 판별 + 범위 설정</div>
          </div>
          <div className="pipe-arrow">→</div>
          <div className="pipe-node active-node">
            <div className="pipe-label">라우터</div>
            <div className="pipe-name">의도 분류기</div>
            <div style={{ fontSize: 10, color: "var(--t2)", marginTop: 3 }}>NLP 기반 도메인 분류</div>
          </div>
          <div className="pipe-arrow">→</div>
          ...
          <div className="pipe-node active-node">
            ...
            <div style={{ fontSize: 10, color: "var(--t2)", marginTop: 3 }}>골든 쿼리 우선 매칭</div>
          </div>
          <div className="pipe-arrow">→</div>
          <div className="pipe-node active-node">
            <div className="pipe-label">후처리</div>
            <div className="pipe-name">정책 필터</div>
            <div style={{ fontSize: 10, color: "var(--t2)", marginTop: 3 }}>PII 마스킹 + 감사 기록</div>
          </div>
          <div className="pipe-arrow">→</div>
          <div className="pipe-node active-node">
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 4, flexWrap: "wrap" }}>
          <div className="pipe-node fallback" style={{ minWidth: "auto", padding: "6px 12px" }}>
            ...
            <div className="pipe-name" style={{ fontSize: 11 }}>RAG 재시도 → 오류 안내</div>
          </div>
          <div className="pipe-node fallback" style={{ minWidth: "auto", padding: "6px 12px" }}>
            <div className="pipe-label">Cross-Agent</div>
            <div className="pipe-name" style={{ fontSize: 11 }}>도메인 초과 시 핸드오프</div>
          </div>
        </div>
      </div>
      ...
      <div className="g2">
        <div className="card">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td><span className="b bg">생산관리 Agent</span></td>
                  <td className="sub">1</td>
                  <td className="sub">On</td>
                </tr>
                <tr>
                  <td className="mono">주문, 발주, 마감, 추천량</td>
                  <td><span className="b bb">주문관리 Agent</span></td>
                  <td className="sub">1</td>
                  <td className="sub">On</td>
                </tr>
                <tr>
                  <td className="mono">매출, 손익, 마진, 달성</td>
                  <td><span className="b bo">매출관리 Agent</span></td>
                  <td className="sub">1</td>
                  <td className="sub">On</td>
                </tr>
                <tr>
                  <td className="mono">기타 / 분류 불가</td>
                  <td><span className="b bgy">Fallback → RAG</span></td>
          ...
          <button type="button" className="btn btn-g btn-sm" style={{ marginTop: 8 }} onClick={() => onOpenModal("add-rule")}>
            + 규칙 추가
          </button>
        </div>
        ...
        <div className="card">
          ...
          <div style={{ marginTop: 10 }}>
            <label className="sub" style={{ fontSize: 11, fontWeight: 700 }}>최대 핸드오프 횟수</label>
      ...
      <div className="card" style={{ marginTop: 10 }}>
        <div className="ch">
          ...
          <button type="button" className="btn btn-g btn-sm" style={{ marginLeft: "auto" }}>전체 보기</button>
        </div>
        <div className="tw">
          <table>
            <thead>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span className="b bo">매출관리</span></td>
                <td className="mono">SQL → 매출관리 핸드오프</td>
                <td><span className="b ba">생산→매출</span></td>
                <td className="sub">2.8s</td>
                <td><span className="b ba">부분</span></td>
              </tr>
              <tr>
                ...
                <td><span className="b br">차단</span></td>
              </tr>
            </tbody>
          </table>
        </div>
